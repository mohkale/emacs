...
#+BEGIN_SRC emacs-lisp :tangle yes
  (dolist (hydra '(hydra-eyebrowse
    ...
    (let ((hydra-func (intern (concat (symbol-name hydra) "/body")))
          (hydra-file (bin! "lisp/hydras"  (concat (symbol-name hydra) ".el"))))
...
* text-zoom
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-text-zoom.el
...
* window-management
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-winman.el
...
* eyebrowse
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-eyebrowse.el
...
* emacs-ipython-notebook
  ...
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-ein.el
...
* persp-mode
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-persp.el
    (require 'persp-mode)
...
* flycheck
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-flycheck.el
...
* ibuffer
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-ibuffer.el
...
* ivy
  ...
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-ivy-custom.el
    (require 'ivy-hydra)
...
** agenda
   ...
   #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-org-agenda.el
...
** clock & timers
   ...
   #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-org-clock.el
...
** links
   ...
   #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-org-link.el
...
** navigation
   #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-org-navigate.el
...
* vlc-rc
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-vlc-rc.el
    (require 'vlc-rc)
...
* visual-move
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-visual-move.el
...
* indentation
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-indent.el
...
* vdiff
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-vdiff.el
...
* iedit
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-evil-multiedit.el
...
* flyspell
  #+BEGIN_SRC emacs-lisp :tangle bin/lisp/hydras/hydra-flyspell.el
