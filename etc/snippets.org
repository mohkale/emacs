...
* Aliases
  ...
  #+BEGIN_SRC text :tangle snippets/csharp-ts-mode/.yas-parents :shebang
    csharp-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/css-ts-mode/.yas-parents :shebang
    css-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/java-ts-mode/.yas-parents :shebang
    java-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/json-ts-mode/.yas-parents :shebang
    js-json-mode
    json-mode
    jsonc-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/js-ts-mode/.yas-parents :shebang
    js-mode
    js2-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/python-ts-mode/.yas-parents :shebang
    python-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/bash-ts-mode/.yas-parents :shebang
    sh-mode
    shell-script-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/cmake-ts-mode/.yas-parents :shebang
    cmake-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/dockerfile-ts-mode/.yas-parents :shebang
    dockerfile-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/go-ts-mode/.yas-parents :shebang
    go-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/rust-ts-mode/.yas-parents :shebang
    rust-mode
    rustic-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/toml-ts-mode/.yas-parents :shebang
    toml-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/typescript-ts-mode/.yas-parents :shebang
    typescript-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/tsx-ts-mode/.yas-parents :shebang
    typescript-react-mode
  #+END_SRC

  #+BEGIN_SRC text :tangle snippets/yaml-ts-mode/.yas-parents :shebang
    yaml-mode
  #+END_SRC
